    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to='images/persons/', verbose_name='Фото')),
                ('biography', models.TextField(blank=True, verbose_name='Информация')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Информация')),
                ('picture', models.ImageField(upload_to='images/movies/', verbose_name='Фото')),
